...
void startAndMainMenu()
{
    ...
    RectangleShape backStart;//t³o dla startu
    ...
    while (windowStart.isOpen()) //okno start otworzenie
    {
        ...
        while (windowStart.pollEvent(eventStart))
        {
            ...
            {
                if (eventStart.key.code == Keyboard::Up)// strowanie strza³ka w góre
                {
                    menuStart.MoveUp();
                    break;
                }
                if (eventStart.key.code == Keyboard::Down)//sterowanie strza³ka w dó³
                {
                    menuStart.MoveDown();
                    break;
                }
                        ...
                        while (windowMainMenu.isOpen())//otwracie okna dla main menu
                        {
                            ...
                            while (windowMainMenu.pollEvent(eventMainMenu))
                            {
                                ...
                                if (eventMainMenu.type == Event::KeyReleased)
                                {
                                    ...
                                    if (eventMainMenu.key.code == Keyboard::Down)//sterowanie w dó³
                                    {
                                                ...
                                                while (windowBill.pollEvent(billEvent))
                                                {
                                                    ...
                                                    if (billEvent.type == Event::KeyReleased)
                                                    {
                                                        ...
                                                        if (billEvent.key.code == Keyboard::Return)
                                                        {
                                                            ...
                                                            RectangleShape backNumerOrder;//t³o dla okna numeru zamowienia
                                                            ...
                                                            RectangleShape backDeletingOrder;//t³o dla okna usówania zamówienia
